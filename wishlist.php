            ...
            <div class="product-card" data-product-id="<?php echo $item['product_id']; ?>">
                <div class="product-image">
                    ...
                    <a href="<?php echo SITE_URL; ?>/product-detail.php?id=<?php echo $item['product_id']; ?>">
                        <?php
                        $image_url = 'https://via.placeholder.com/300x250?text=' . urlencode($item['name']);
                        
                        if (!empty($item['image'])) {
                            $image_path = __DIR__ . '/assets/' . $item['image'];
                            if (file_exists($image_path)) {
                                $image_url = SITE_URL . '/assets/' . safe_html($item['image']);
                            }
                        }
                        ?>
